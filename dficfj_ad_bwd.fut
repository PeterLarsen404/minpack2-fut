...
-- ==
-- compiled input {2i64}
-- output {[1.00000, 0.00000, -0.00000, -0.00000, -0.00000, -0.00000, -0.00000, -0.00000, -0.00000, -0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000]}


let main (nint : i64)  =
  let arr_size = nint*8
  let x : [arr_size]f64 = task_XS_opt nint :> [arr_size]f64
  in vjp dficfj_test_ad x (replicate arr_size 1 with [1] = 1)
